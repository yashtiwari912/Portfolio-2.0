            ...
            <footer className="py-16 md:py-32">
                <div className="mx-auto max-w-5xl px-6">
                    ...
                    <div className="my-8 flex flex-wrap justify-center gap-6 text-sm">
                        ...
                        <Link
                            href="https://www.linkedin.com/in/yash-tiwari-237312287/"
                            target="_blank"
                            rel="noopener noreferrer"
                            aria-label="LinkedIn"
                            className="text-muted-foreground hover:text-primary block">
                        ...
                        <Link
                            href="https://www.instagram.com/yash_._tiwari?igsh=aHZ2ZDIzcmtyNzlt"
                            target="_blank"
                            rel="noopener noreferrer"
                    ...
                    <span className="text-muted-foreground block text-center text-sm"> © {new Date().getFullYear()} Yash Tiwari, All rights reserved</span>
                </div>
            </footer>
        </section>
